  ...
  return (
    <HeaderFrame>
      <HeaderRow>
        <Title href=".">
          <Icon>
            <Image width={'22px'} height={'22px'} src={darkMode ? "/svg/logo_white.svg" : "/svg/logo.svg"} alt="logo" />
          </Icon>
        </Title>
      </HeaderRow>
      ...
      <HeaderLinks>
        <Link href={'/swap'} passHref>
          <StyledNavLink id={`swap-nav-link`} isActive={router.pathname === '/swap'}>
            {t('Swap')}
          </StyledNavLink>
        </Link>
        <Link href={'/pool'} passHref>
          <StyledNavLink id={`pool-nav-link`} isActive={router.pathname === '/pool'}>
            {t('Liquidity')}
          </StyledNavLink>
        </Link>
