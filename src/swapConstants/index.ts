...
export const BITGERT_USDC = new Token(ChainId.BITGERT, '0x765277EebeCA2e31912C9946eAe1021199B39C61', 6, 'USDCm', 'USD Coin Multichain');
export const BITGERT_USDT = new Token(ChainId.BITGERT, '0xE3F5a90F9cb311505cd691a46596599aA1A0AD7D', 6, 'USDTm', 'Tether USD Multichain');
...
export const BITGERT_USDTI = new Token(ChainId.BITGERT, '0xC7E6d7E08A89209F02af47965337714153c529F0', 18, 'USDTi', 'Tether USD IcecreamSwap');
...
export const BITGERT_USDCI = new Token(ChainId.BITGERT, '0xaEdD3Ff7b9Fc5fc4e44d140b80f0B1C7FdB6102c', 18, 'USDCi', 'USD Coin IcecreamSwap');
