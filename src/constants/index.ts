...
export const BITGERT_USDC = new Token(ChainId.BITGERT, '0x765277EebeCA2e31912C9946eAe1021199B39C61', 6, 'USDC', 'USD Coin');
export const BITGERT_USDT = new Token(ChainId.BITGERT, '0xE3F5a90F9cb311505cd691a46596599aA1A0AD7D', 6, 'USDT', 'Tether USD');
